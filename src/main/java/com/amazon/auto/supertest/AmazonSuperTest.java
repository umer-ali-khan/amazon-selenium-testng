...
public abstract class AmazonSuperTest
{
  ...
  private static void setCapabilities() throws Exception
  {
    ...
    capabilities.setCapability("browserName",
        properties.getProperty(Constants.Caps.DC_BROWSER_NAME));
    capabilities.setCapability("platform",
        properties.getProperty(Constants.Caps.DC_BROWSER_PLATFORM));
    capabilities.setCapability("version",
        properties.getProperty(Constants.Caps.DC_BROWSER_VERSION));
